...
1.	Расширить структуру для передачи дополнительных данных в сторонний контрол.
...
4.	Более подробно про варианты расширения функциональности можно узнать в документации библиотеки [react-d3-tree](https://www.npmjs.com/package/react-d3-tree).
